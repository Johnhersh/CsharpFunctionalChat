...
{
    public static async Task<CoreContext> BuildMessagesAsync(int sessionId, CoreContext context)
    {
...
{
    public static async Task DeductPointsAsync(int playerId, CoreContext context)
    {
        // Deduct points only after successful response generation
        await EntitlementService.DeductPointsAsync(playerId, context.AiResponseResult.TokensUsed);
    }

    public static string BuildFinalResult(string playerName, CoreContext context)
    {
